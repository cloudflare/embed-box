...
},function(A,e){},function(A,e,t){var E=t(1)["default"];if(window){if(!window.EmbedBoxCustom)throw new Error("EmbedBoxCustom was not found while attaching target `wordpress`");window.EmbedBoxCustom.fetchedTargets.push(E)}else A.exports=E}])});
