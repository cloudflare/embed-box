(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("EmbedBoxGenericPage", [], factory);
	else if(typeof exports === 'object')
		exports["EmbedBoxGenericPage"] = factory();
	else
		root["EmbedBoxGenericPage"] = factory();
})(this, function() {
...
/* harmony export */ __webpack_require__.d(exports, "default", function() { return GenericPage; });var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
;
//# sourceMappingURL=embed-box-page-generic.map