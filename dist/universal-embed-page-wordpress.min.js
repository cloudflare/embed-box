...
},function(A,E){},function(A,E,I){var Q=I(1)["default"];if(window){if(!window.UniversalEmbedCustom)throw new Error("UniversalEmbedCustom was not found while attaching page `wordpress`");window.UniversalEmbedCustom.pages.push(Q)}else A.exports=Q}])});
//# sourceMappingURL=universal-embed-page-wordpress.min.map