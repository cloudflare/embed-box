...
},function(A,e){},function(A,e,E){var t=E(1)["default"];if(window){if(!window.EmbedBoxCustom)throw new Error("EmbedBoxCustom was not found while attaching page `wordpress`");window.EmbedBoxCustom.fetchedPages.push(t)}else A.exports=t}])});
//# sourceMappingURL=embed-box-page-wordpress.min.map