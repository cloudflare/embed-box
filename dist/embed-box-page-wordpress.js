(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("EmbedBoxWordpressPage", [], factory);
	else if(typeof exports === 'object')
		exports["EmbedBoxWordpressPage"] = factory();
	else
		root["EmbedBoxWordpressPage"] = factory();
})(this, function() {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__wordpress_pug__ = __webpack_require__(11);
...
var WordpressPage = (_temp = _class = function (_BasePage) {
  _inherits(WordpressPage, _BasePage);

  function WordpressPage() {
    _classCallCheck(this, WordpressPage);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(WordpressPage).apply(this, arguments));
  }

  return WordpressPage;
}(__WEBPACK_IMPORTED_MODULE_1_components_base_page__["a" /* default */]), _class.fallback = false, _class.id = "wordpress", _class.label = "WordPress", _class.template = __WEBPACK_IMPORTED_MODULE_0__wordpress_pug___default.a, _temp);
...
var BasePage = (_class = (_temp = _class2 = function (_BaseComponent) {
  ...
  return _temp2 = _class3 = function (_BasePage) {
    ...
    return CustomPage;
  }(BasePage), _class3.fallback = fallback || false, _class3.id = id, _class3.label = label, _class3.template = template || "", _class3.templateVars = templateVars || {}, _temp2;
...
;
//# sourceMappingURL=embed-box-page-wordpress.map