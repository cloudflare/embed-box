...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__generic_pug__ = __webpack_require__(15);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_components_base_target__ = __webpack_require__(5);
...
}(__WEBPACK_IMPORTED_MODULE_1_components_base_target__["a" /* default */]), _class.fallback = true, _class.id = "generic", _class.label = "Any other site", _class.template = __WEBPACK_IMPORTED_MODULE_0__generic_pug___default.a, _temp);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lib_store__ = __webpack_require__(1);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__before_content_pug__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__after_content_pug__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_clipboard__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lib_store__ = __webpack_require__(1);
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
    if (true) {
        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, __webpack_require__(6), __webpack_require__(17), __webpack_require__(11)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
    } else if (typeof exports !== "undefined") {
...
function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;var locals_for_with = (locals || {});(function (config) {pug_html = pug_html + "\u003Csection\u003E\u003Ch1\u003EInstalling " + (pug.escape(null == (pug_interp = config.name) ? "" : pug_interp)) + "\u003C\u002Fh1\u003E" + (null == (pug_interp = this.renderBeforeContent()) ? "" : pug_interp) + "\u003Col class=\"steps\"\u003E";
if (this.downloadURL) {
pug_html = pug_html + "\u003Cli\u003E\u003Ch2\u003E\u003Ca" + (" class=\"more\""+" target=\"_blank\""+pug.attr("href", this.downloadURL, true, true)) + "\u003E" + (pug.escape(null == (pug_interp = this.downloadLabel) ? "" : pug_interp)) + "\u003C\u002Fa\u003E\u003Cdiv\u003E" + (pug.escape(null == (pug_interp = this.autoDownloadLabel) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E\u003C\u002Fh2\u003E\u003C\u002Fli\u003E";
}
pug_html = pug_html + "\u003Cli\u003E\u003Ch2\u003ECopy the code to your site's &lt;" + (pug.escape(null == (pug_interp = this.location) ? "" : pug_interp)) + "&gt; tag.\u003C\u002Fh2\u003E\u003Cdiv class=\"copy-container\"\u003E\u003Cbutton class=\"primary run\" data-ref=\"copyButtons[]\"\u003ECopy\u003C\u002Fbutton\u003E\u003Cdiv class=\"copyable\" contenteditable\u003E" + (pug.escape(null == (pug_interp = this.copyText) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cfigure\u003E\u003Cimg" + (pug.attr("src", __webpack_require__(18), true, true)) + "\u003E\u003C\u002Ffigure\u003E\u003C\u002Fli\u003E\u003Cli\u003E\u003Ch2\u003EVisit your site\u003C\u002Fh2\u003E\u003Cp\u003EAfter saving the changes you made, visit your site in the browser.\u003C\u002Fp\u003E\u003Cp\u003EYou’re done!\u003C\u002Fp\u003E\u003C\u002Fli\u003E\u003C\u002Fol\u003E" + (null == (pug_interp = this.renderAfterContent()) ? "" : pug_interp) + "\u003C\u002Fsection\u003E";}.call(this,"config" in locals_for_with?locals_for_with.config:typeof config!=="undefined"?config:undefined));;return pug_html;};
module.exports = template;
...
var GenericTarget = __webpack_require__(2).default;
