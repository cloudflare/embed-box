...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__generic_pug__ = __webpack_require__(16);
...
}(__WEBPACK_IMPORTED_MODULE_1_components_base_target__["a" /* default */]), _class.id = "generic", _class.label = "Any other site", _class.template = __WEBPACK_IMPORTED_MODULE_0__generic_pug___default.a, _temp);
...
pug_html = pug_html + "\u003Cli\u003E\u003Ch2\u003ECopy the code to your site's &lt;" + (pug.escape(null == (pug_interp = this.location) ? "" : pug_interp)) + "&gt; tag.\u003C\u002Fh2\u003E\u003Cdiv class=\"copy-container\"\u003E\u003Cbutton class=\"primary run\" data-ref=\"copyButtons[]\"\u003ECopy\u003C\u002Fbutton\u003E\u003Cdiv class=\"copyable\" contenteditable\u003E" + (pug.escape(null == (pug_interp = this.copyText) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cfigure\u003E\u003Cimg" + (pug.attr("src", __webpack_require__(27), true, true)) + "\u003E\u003C\u002Ffigure\u003E\u003C\u002Fli\u003E\u003Cli\u003E\u003Ch2\u003EVisit your site\u003C\u002Fh2\u003E\u003Cp\u003EAfter saving the changes you made, visit your site in the browser.\u003C\u002Fp\u003E\u003Cp\u003EYou’re done!\u003C\u002Fp\u003E\u003C\u002Fli\u003E\u003C\u002Fol\u003E" + (null == (pug_interp = this.renderAfterContent()) ? "" : pug_interp) + "\u003C\u002Fsection\u003E";;return pug_html;};
module.exports = template;
...
var GenericTarget = __webpack_require__(3).default;
